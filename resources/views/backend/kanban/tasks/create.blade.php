<x-backend-layout>
    <div class="pl-4 my-5">
        ...
        <div class="w-full shadow p-5 rounded-md">
            <h3 class="text-gray-700 text-lg capitalize">Add New Task</h3>
            ...
            <form method="POST" action="">
                ...
                <div class="flex flex-col space-y-4 my-8">
                    <div>
                        ...
                        <input type="text" name="name" class="w-full border rounded-md">
                        @error('name')
                    ...
                    <div>
                        ...
                        <input type="number" name="order" class="w-full border rounded-md">
                        @error('order')
                        <div class="text-red-600 text-xs">{{ $message }}</div>
                        @enderror
                    </div>
